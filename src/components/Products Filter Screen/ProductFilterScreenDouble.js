    ...
    <View
      ...
      <View
        ...
        <View style={{position: 'relative'}}>
          <Image
            source={{
              uri: 'https://rukminim2.flixcart.com/image/832/832/xif0q/bed/j/y/5/-original-imagpprf9wppvhuy.jpeg?q=70',
            }}
        ...
        <View style={{marginTop: 10, paddingHorizontal: 10}}>
          ...
          <View style={[styles.dFlex, {marginTop: 10}]}>
            <Text style={{fontSize: 12, color: '#228b22', fontWeight: '600'}}>
              16% Off
            </Text>
            <Text
              style={{
          ...
          <View style={[styles.dFlex, {marginTop: 5, paddingBottom: 5}]}>
            <Text style={{fontSize: 10, color: '#36454F', fontWeight: '500'}}>
              Free Delivery
            </Text>
            <Text style={{fontSize: 10, color: '#36454F', fontWeight: '500'}}>
              {' '}
